...
def main(tracking_method, sequence):
    ...
    tracking_dirs = {
        ...
        'deepsort': 'DeepSORT__input_1280__conf_.25',
        'litesort': 'LiteSORT__input_1280__conf_.25',
        'sort': 'SORT__input_1280__conf_.25',
        'strongsort': 'StrongSORT__input_1280__conf_.25'
    }
    ...
    result_file = f'/media/hbai/data/code/LiteSORT/results/ablation/PersonPath22/person_path_22-test/{tracking_dir}/data/{sequence}.txt'
