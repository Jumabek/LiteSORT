...
class opts:
    def __init__(self):
        ...
        self.parser.add_argument(
            'tracker_name',
            type=str,
            help='LiteSORT or StrongSORT or DeepSORT or SORT',
        )
        self.parser.add_argument(
            '--input_resolution',
            type=int,
